...
type UserModel struct {
	...
	NumFans  int64  `protobuf:"varint,5,opt,name=num_fans,json=numFans,proto3" json:"num_fans,omitempty"`
	NumIdols int64  `protobuf:"varint,6,opt,name=num_idols,json=numIdols,proto3" json:"num_idols,omitempty"`
}
...
func (x *UserModel) GetNumFans() int64 {
	if x != nil {
		return x.NumFans
	}
	return 0
...
func (x *UserModel) GetNumIdols() int64 {
	if x != nil {
		return x.NumIdols
	}
	return 0
...
var file_userService_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa7, 0x01, 0x0a,
	0x09, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73,
	...
	0x0a, 0x08, 0x6e, 0x75, 0x6d, 0x5f, 0x66, 0x61, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x07, 0x6e, 0x75, 0x6d, 0x46, 0x61, 0x6e, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x75, 0x6d,
	0x5f, 0x69, 0x64, 0x6f, 0x6c, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6e, 0x75,
	0x6d, 0x49, 0x64, 0x6f, 0x6c, 0x73, 0x22, 0x71, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x86, 0x01, 0x0a, 0x0c, 0x55, 0x73,
	...
	0x67, 0x65, 0x12, 0x2e, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55,
	0x73, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e,
	0x66, 0x6f, 0x32, 0xfe, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_userService_proto_depIdxs = []int32{
	0, // 0: service.UserResponse.userInfo:type_name -> service.UserModel
	1, // 1: service.UserService.UserLogin:input_type -> service.UserRequest
	1, // 2: service.UserService.UserRegister:input_type -> service.UserRequest
	1, // 3: service.UserService.DeleteUser:input_type -> service.UserRequest
	1, // 4: service.UserService.ModifyUserInfo:input_type -> service.UserRequest
	2, // 5: service.UserService.UserLogin:output_type -> service.UserResponse
	2, // 6: service.UserService.UserRegister:output_type -> service.UserResponse
	2, // 7: service.UserService.DeleteUser:output_type -> service.UserResponse
	2, // 8: service.UserService.ModifyUserInfo:output_type -> service.UserResponse
